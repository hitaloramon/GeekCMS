    ...
    <div class="right-sidebar">
        <div class="slimscrollright">
            ...
            <div class="r-panel-body geek-help">
                <h5>Menus</h5>
                <p>Arraste e solte os itens para mudar suas posições. Clique no icone <i class="fa fa-lg fa-pencil-square-o"></i> do menu correspondente acessar as opções de edição. 
                Clique no ícone <i class="fa fa-lg fa-trash-o"></i> para excluir um item do menu. Clique no botão Salvar Posição para salvar as posições de menu. 
                Nota: A exclusão de menu principal também vai apagar todas os submenus atribuídos ao menu principal que será apagado.</p>
                <hr>
