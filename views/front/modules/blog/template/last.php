        ...
        <div class="row m-b-30">
            ...
            <div class="col-md">
                ...
                <ul class="list-inline list-unstyled">
                    ...
                    <li>|</li>
                    <li><small class="text-muted"><i class="fas fa-tag"></i> <a href="<?php echo BASE.'/'. $post['blogslug'].'/categoria/'. $post['category_slug'].'';?>"><?php echo $post['category']; ?></a></small> </li>
                </ul>
